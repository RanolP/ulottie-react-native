...
// runtime symbols: fmt, r, r2, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, open, css, EASE, SP_SEG, spBuild, spSample, spSeg, lerpPath, T_SCALAR, T_VECTOR, T_PATH, T_EXPR, F_EASE, F_HOLD, F_SPATIAL, pseg, pease, pv, pvv, pslice, pvp, mkPath, xv, xvv, vscratch, pdim, pdPair, pdSep, pathD, bTranslate, oTranslate, hasTrim, bShape, oShape, bFill, oFill, skSet, skMatrix, skNums, skGeom, skPaints, skGrad, skOwn, skFxPaint, mountRn, skPrepare, skGradRec, skDraw, skFx, skShape, skGeomDraw, mountSkia
...
export const dl =
{ k: 0, c: [
  { k: 0, clip: { r: [0, 0, 174, 149] }, c: [
    { k: 0, m: [1, 0, 75.75, 0, 1, 74.5, 0, 0, 1], c: [
      { k: 0, s: 2, m: [1, 0, -82.5, 0, 1, -52.4, 0, 0, 1], c: [
        { k: 0, m: [1, 0, 73.72, 0, 1, 19.27, 0, 0, 1], c: [
          { k: 1, s: 4, d: 'M54.455,9.267L-54.454,9.267C-59.572,9.267-63.722,5.118-63.722,0C-63.722-5.118-59.572-9.267-54.454-9.267L54.455-9.267C59.573-9.267,63.722-5.118,63.722,0C63.722,5.118,59.573,9.267,54.455,9.267Z', paint: { ml: 10, sc: '#9b2236', sw: 4 } }
        ] }
      ] },
      { k: 0, s: 5, m: [1, 0, -82.5, 0, 1, -19.97, 0, 0, 1], c: [
        { k: 0, m: [1, 0, 80.6, 0, 1, 19.02, 0, 0, 1], c: [
...
export const init = (Sk) => { 'worklet'; return mountSkia(D, P0, A0, 15, { p: SP }, Sk, dl); };
