...
// runtime symbols: fmt, r, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, open, SP_SEG, spBuild, spSample, spSeg, T_SCALAR, T_VECTOR, T_EXPR, F_EASE, F_HOLD, F_SPATIAL, pseg, pease, pvv, pslice, xvv, bGradient, oGradient, bRamp, oRamp, skSet, skMatrix, skNums, skGeom, skPaints, skGrad, skOwn, skFxPaint, mountRn, skPrepare, skGradRec, skDraw, skFx, skShape, skGeomDraw, mountSkia
...
function bGradient(x, base, eb, sb, ps, at) { 'worklet';
...
function oGradient(x, s) { 'worklet';
...
function bRamp(x, base, eb, sb, ps, at) { 'worklet';
...
function P0(x, B, e, l, q, a) { 'worklet'; return [bGradient(x, B[0], e, l, q, a), bRamp(x, B[1], e, l, q, a)]; }
function A0(x, S) { 'worklet'; oGradient(x, S[0]); oRamp(x, S[1]); }
...
{ k: 0, c: [
  { k: 0, clip: { r: [0, 0, 1080, 1920] }, c: [
    { k: 2, h: 1920, w: 1080, x: 0, y: 0, paint: { f: '#be2a2a' } },
    { k: 0, m: [1, 0, 540, 0, 1, 960, 0, 0, 1], c: [
      { k: 0, m: [0.9329, 0, 0, 0, 2.19491, 0, 0, 0, 1], c: [
        { k: 2, h: 880, w: 1160, x: -580, y: -440, paint: { f: { lin: 1, s: 6, x1: -430.769, y1: -404.573, x2: 374.412, y2: 342.611, st: [[0, 'rgb(130,227,72)', 7], [0.5, 'rgb(85,223,149)', 8], [1, 'rgb(40,219,225)', 9]] }, sc: '#fec825', sw: 6 } }
      ] }
    ] }
  ] }
] };

export const meta = { fr: 15, ip: 0, op: 155, width: 1080, height: 1920 };
export const init = (Sk) => { 'worklet'; return mountSkia(D, P0, A0, 10, null, Sk, dl); };
