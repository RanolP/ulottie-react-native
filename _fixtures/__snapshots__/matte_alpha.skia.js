      ...
      { k: 0, s: 6, m: [.98163, .19081, -13.62, -.19081, .98163, 10.46, 0, 0, 1], c: [
        { k: 0, s: 7, m: [.98769, -.15643, 8.44, .15643, .98769, -7.21, 0, 0, 1], c: [
          { k: 0, clip: { r: [0, 0, 100, 100] }, c: [
            ...
            { k: 0, mask: { c: [
              { k: 0, m: [1, 0, -34, 0, 1, 462, 0, 0, 1], c: [
                { k: 1, s: 32, d: 'M84-398.906C88.971-398.906,91.5-399.5,91.5-397C91.5-394.406,88.971-395,84-395C79.029-395,76.75-394.781,76.75-397C76.75-399.344,79.029-398.906,84-398.906Z', paint: { f: 'rgb(84,84,71)' } }
              ] }
            ] }, c: [
            ...
            { k: 0, mask: { c: [
              { k: 0, m: [1, 0, -34, 0, 1, 462, 0, 0, 1], c: [
                { k: 1, s: 29, d: 'M84-398.906C88.971-398.906,91.5-399.5,91.5-397C91.5-394.406,88.971-395,84-395C79.029-395,76.75-394.781,76.75-397C76.75-399.344,79.029-398.906,84-398.906Z', paint: { f: 'rgb(84,84,71)' } }
              ] }
            ] }, c: [
