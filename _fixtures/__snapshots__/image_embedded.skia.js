...
// runtime symbols: fmt, r, r5, r2, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, mtx, open, T_SCALAR, T_VECTOR, T_EXPR, F_EASE, F_HOLD, F_SPATIAL, pseg, pease, pv, pvv, pslice, xv, xvv, bTransform, oTransform, skSet, skMatrix, skNums, skGeom, skPaints, skGrad, skOwn, skFxPaint, mountRn, skPrepare, skGradRec, skDraw, skFx, skShape, skGeomDraw, mountSkia
...
{ k: 0, c: [
  { k: 0, clip: { r: [0, 0, 200, 200] }, c: [
    { k: 0, s: 1, m: [4, 0, 68, 0, 4, 68, 0, 0, 1], c: [
      { k: 4, w: 16, h: 16, u: 'iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAG0lEQVR42mP4z8BAEmIY1UAbDXdIQ6MaaKIBAM3lbRBS1Ti1AAAAAElFTkSuQmCC' }
    ] }
  ] }
] };

export const meta = { fr: 30, ip: 0, op: 60, width: 200, height: 200 };
export const init = (Sk) => { 'worklet'; return mountSkia(D, P0, A0, 3, null, Sk, dl); };
