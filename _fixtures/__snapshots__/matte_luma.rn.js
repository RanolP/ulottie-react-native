...
{ type: 'Svg', staticProps: { viewBox: '0 0 100 100', width: '100%', height: '100%', preserveAspectRatio: 'xMidYMid meet' }, children: [
  ...
  { type: 'Defs', staticProps: {  }, children: [
    { type: 'Mask', staticProps: { id: 't0', maskType: 'luminance', maskUnits: 'userSpaceOnUse', x: '0', y: '0', width: '100', height: '100' }, children: [
      { type: 'G', staticProps: { transform: [1, 0, 0, 1, -34, 462] }, children: [
    ...
    { type: 'Mask', staticProps: { id: 't1', maskType: 'luminance', maskUnits: 'userSpaceOnUse', x: '0', y: '0', width: '100', height: '100' }, children: [
      { type: 'G', staticProps: { transform: [1, 0, 0, 1, -34, 462] }, children: [
