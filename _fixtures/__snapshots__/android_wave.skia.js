...
// runtime symbols: fmt, r, r5, r2, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, mtx, open, EASE, SP_SEG, spBuild, spSample, spSeg, T_SCALAR, T_VECTOR, T_EXPR, F_EASE, F_HOLD, F_SPATIAL, pseg, pease, pv, pvv, pslice, xv, xvv, bTransform, oTransform, bTranslate, oTranslate, bOpacity, oOpacity, skSet, skMatrix, skNums, skGeom, skPaints, skGrad, skOwn, skFxPaint, mountRn, skPrepare, skGradRec, skDraw, skFx, skShape, skGeomDraw, mountSkia
...
export const dl =
{ k: 0, c: [
  { k: 0, clip: { r: [0, 0, 400, 400] }, c: [
    { k: 0, m: [0.952, 0, 143.42, 0, 0.952, 152.23, 0, 0, 1], c: [
      { k: 0, s: 2, m: [1, 0, -246.54, 0, 1, -327.35, 0, 0, 1], c: [
        { k: 0, m: [1, 0, -1.05, 0, 1, 0, 0, 0, 1], c: [
          { k: 0, m: [1, 0, 305.75, 0, 1, 367.21, 0, 0, 1], c: [
            { k: 1, d: 'M-66.199-32.931C-72.261-32.931-77.176-27.94-77.176-21.783L-77.176,21.783C-77.176,27.94-72.261,32.931-66.199,32.931C-60.137,32.931-55.222,27.94-55.222,21.783L-55.222-21.783C-55.222-27.94-60.137-32.931-66.199-32.931Z', paint: { f: '#a4c639' } }
          ] },
          { k: 0, m: [1, 0, 305.75, 0, 1, 367.21, 0, 0, 1], c: [
            { k: 1, d: 'M-66.199-32.931C-72.261-32.931-77.176-27.94-77.176-21.783L-77.176-3.217L-55.222-3.217L-55.222-21.783C-55.222-27.94-60.137-32.931-66.199-32.931Z', paint: { f: '#f05c61' } }
          ] }
        ] },
        { k: 0, m: [1, 0, -1.05, 0, 1, 0, 0, 0, 1], c: [
          { k: 0, m: [1.05042, 0, 96.94, 0, 1.05042, 167.45, 0, 0, 1], c: [
            { k: 0, clip: { r: [0, 0, 400, 400] }, c: [
              { k: 0, s: 11, m: [0.952, 0, -91.29, 0, 0.952, -159.41, 0, 0, 1], c: [
                { k: 0, m: [1, 0, 305.75, 0, 1, 367.21, 0, 0, 1], c: [
                  { k: 1, d: 'M66.199-32.931C60.138-32.931,55.223-27.94,55.223-21.783L55.223,21.783C55.223,27.94,60.138,32.931,66.199,32.931C72.262,32.931,77.176,27.94,77.176,21.783L77.176-21.783C77.176-27.94,72.262-32.931,66.199-32.931Z', paint: { f: '#a4c639' } }
                ] },
                { k: 0, m: [1, 0, 305.75, 0, 1, 367.21, 0, 0, 1], c: [
                  { k: 1, d: 'M66.199-32.931C60.138-32.931,55.223-27.94,55.223-21.783L55.223-3.217L77.176-3.217L77.176-21.783C77.176-27.94,72.262-32.931,66.199-32.931Z', paint: { f: '#f05c61' } }
                ] }
              ] }
            ] }
          ] }
      ...
      { k: 0, m: [1, 0, -246.54, 0, 1, -327.35, 0, 0, 1], c: [
        { k: 0, m: [1, 0, 287.08, 0, 1, 425.23, 0, 0, 1], c: [
          { k: 1, d: 'M0-32.931C-6.062-32.931-10.977-27.94-10.977-21.784L-10.977,21.783C-10.977,27.94-6.062,32.931,0,32.931C6.062,32.931,10.977,27.94,10.977,21.783L10.977-21.784C10.977-27.94,6.062-32.931,0-32.931Z', paint: { f: '#a4c639' } }
        ] }
      ] },
      { k: 0, m: [1, 0, -246.54, 0, 1, -327.35, 0, 0, 1], c: [
        { k: 0, m: [1, 0, 326, 0, 1, 425.23, 0, 0, 1], c: [
          { k: 1, d: 'M0-32.931C-6.062-32.931-10.977-27.94-10.977-21.784L-10.977,21.783C-10.977,27.94-6.062,32.931,0,32.931C6.062,32.931,10.977,27.94,10.977,21.783L10.977-21.784C10.977-27.94,6.062-32.931,0-32.931Z', paint: { f: '#a4c639' } }
        ] }
      ] },
      { k: 0, s: 22, m: [1, 0, -246.54, 0, 1, -327.35, 0, 0, 1], c: [
        { k: 0, m: [1, 0, 305.97, 0, 1, 378.69, 0, 0, 1], c: [
          { k: 1, d: 'M-48.835-44.077L-48.835,35.517C-48.835,40.245-45.002,44.077-40.275,44.077L-30.496,44.077L-8.542,44.077L8.542,44.077L30.496,44.077L40.274,44.077C45.003,44.077,48.835,40.245,48.835,35.517L48.835-44.077L-48.835-44.077Z', paint: { f: '#a4c639' } }
        ] }
      ] },
      { k: 0, s: 25, m: [1, 0, -246.54, 0, 1, -327.35, 0, 0, 1], c: [
        { k: 0, m: [1, 0, 305.97, 0, 1, 378.69, 0, 0, 1], c: [
          { k: 1, d: 'M-48.835-44.077L-48.835,27.183L48.835,27.183L48.835-44.077L-48.835-44.077Z', paint: { f: '#f05c61' } }
        ] },
        { k: 0, m: [0.66333, 0, 182.72, 0, 0.66333, -90.57, 0, 0, 1], c: [
          { k: 0, m: [1, 0, 195.06, 0, 1, 608.65, 0, 0, 1], c: [
            { k: 1, d: 'M-9,105.655C-12.137,101.969-15.799,96.859-16.931,91.894C-17.258,90.461-17.391,88.967-17.165,87.496C-16.982,86.307-16.57,85.186-15.885,84.187C-14.328,81.916-11.677,80.743-9.001,80.743C-6.325,80.743-3.672,81.915-2.115,84.187C-1.43,85.186-1.016,86.307-0.834,87.497C-0.608,88.969-0.743,90.463-1.07,91.897C-2.202,96.861-5.863,101.97-9,105.655ZM-9,105.655C-6.667,108.396-3.822,111.312-0.604,113.123C1.043,114.05,2.809,114.708,4.706,114.928C6.592,115.147,8.481,114.913,10.246,114.197C13.816,112.748,16.344,109.514,16.89,105.701C17.167,103.769,16.913,101.97,16.267,100.15C16.022,99.46,15.735,98.788,15.439,98.119C14.974,97.066,14.491,96.021,14.009,94.975L14.009,94.975C9.851,85.954,5.449,76.933,0.801,67.913C0.258,66.858-0.282,65.802-0.844,64.757C-1.408,63.709-1.984,62.69-2.766,61.774C-4.356,59.911-6.531,58.853-9,58.853C-11.47,58.853-13.644,59.911-15.235,61.775C-16.016,62.691-16.594,63.71-17.157,64.758C-17.718,65.802-18.258,66.859-18.801,67.913C-23.448,76.934-27.851,85.954-32.009,94.975C-32.491,96.021-32.974,97.066-33.439,98.119C-33.735,98.788-34.022,99.46-34.267,100.15C-34.913,101.97-35.167,103.769-34.89,105.701C-34.344,109.514-31.816,112.748-28.246,114.197C-26.481,114.913-24.592,115.147-22.706,114.928C-20.809,114.708-19.043,114.05-17.396,113.123C-14.179,111.312-11.333,108.396-9,105.655', paint: { cap: 1, join: 1, sc: '#fff', sw: 4 } }
          ] }
        ] },
        { k: 0, m: [1, 0, 305.75, 0, 1, 302.52, 0, 0, 1], c: [
          { k: 1, d: 'M-20.603,11.496C-23.588,11.496-26.007,9.077-26.007,6.092C-26.007,3.108-23.588,0.688-20.603,0.688C-17.618,0.688-15.2,3.108-15.2,6.092C-15.2,9.077-17.618,11.496-20.603,11.496ZM21.278,11.496C18.294,11.496,15.875,9.077,15.875,6.092C15.875,3.108,18.294,0.688,21.278,0.688C24.263,0.688,26.682,3.108,26.682,6.092C26.682,9.077,24.263,11.496,21.278,11.496Z', paint: { f: '#fff' } }
        ] },
        { k: 0, m: [1.05042, 0, 305.97, 0, 1.05042, 304, 0, 0, 1], c: [
          { k: 0, s: 34, o: 0, c: [
            { k: 0, m: [1, 0, 1.29, 0, 1, 12.87, 0, 0, 1], c: [
              { k: 2, h: 12.271, w: 65.58, x: -32.79, y: -6.136, paint: { f: '#a4c639' } }
            ] },
            { k: 0, m: [1, 0, 0.63, 0, 1, 2.04, 0, 0, 1], c: [
              { k: 2, h: 5.43, w: 59.258, x: -29.629, y: -2.715, paint: { f: '#a4c639' } }
            ] }
          ] }
        ] },
        { k: 0, m: [1, 0, 305.75, 0, 1, 302.52, 0, 0, 1], c: [
          { k: 1, d: 'M23.151-9.145L32.174-22.242C32.709-23.02,32.576-24.042,31.876-24.524C31.175-25.006,30.174-24.767,29.638-23.988L20.266-10.384C14.091-12.817,7.228-14.173,0-14.173C-7.229-14.173-14.091-12.817-20.266-10.384L-29.639-23.988C-30.174-24.767-31.176-25.006-31.876-24.524C-32.576-24.042-32.709-23.02-32.174-22.242L-23.151-9.145C-37.495-2.472-47.555,10.207-48.835,25.006L48.835,25.006C47.554,10.207,37.495-2.472,23.151-9.145ZM-20.603,11.496C-23.588,11.496-26.007,9.077-26.007,6.092C-26.007,3.108-23.588,0.688-20.603,0.688C-17.618,0.688-15.2,3.108-15.2,6.092C-15.2,9.077-17.618,11.496-20.603,11.496ZM21.278,11.496C18.294,11.496,15.875,9.077,15.875,6.092C15.875,3.108,18.294,0.688,21.278,0.688C24.263,0.688,26.682,3.108,26.682,6.092C26.682,9.077,24.263,11.496,21.278,11.496Z', paint: { f: '#a4c639' } }
        ] }
      ] }
    ] }
  ] }
...
export const init = (Sk) => { 'worklet'; return mountSkia(D, P0, A0, 41, null, Sk, dl); };
