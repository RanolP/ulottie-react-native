...
// runtime symbols: fmt, r, r2, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, open, EASE, SP_SEG, spBuild, spSample, spSeg, T_SCALAR, T_VECTOR, T_EXPR, F_EASE, F_HOLD, F_SPATIAL, pseg, pease, pvv, pslice, xvv, bTranslate, oTranslate, skSet, skMatrix, skNums, skGeom, skPaints, skGrad, skOwn, skFxPaint, mountRn, skPrepare, skGradRec, skDraw, skFx, skShape, skGeomDraw, mountSkia
...
function P0(x, B, e, l, q, a) { 'worklet'; return [bTranslate(x, B[0], e, l, q, a)]; }
...
{ k: 0, c: [
  { k: 0, clip: { r: [0, 0, 1080, 2330] }, c: [
    ...
    { k: 0, bm: 24, m: [1, 0, 540, 0, 1, 1165, 0, 0, 1], c: [
      { k: 0, m: [1, 0, 4, 0, 1, -261, 0, 0, 1], c: [
        { k: 2, h: 608, w: 608, x: -304, y: -304, paint: { f: '#1caff4', sc: '#fefefe', sw: 0 } }
      ] }
    ] }
  ] }
] };

export const meta = { fr: 25, ip: 0, op: 50, width: 1080, height: 2330 };
export const init = (Sk) => { 'worklet'; return mountSkia(D, P0, A0, 8, { p: SP }, Sk, dl); };
