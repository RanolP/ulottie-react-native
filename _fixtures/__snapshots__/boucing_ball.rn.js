...
// runtime symbols: fmt, r5, r2, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, mtx, open, EASE, SP_SEG, spBuild, spSample, spSeg, T_SCALAR, T_VECTOR, T_EXPR, F_EASE, F_HOLD, F_SPATIAL, pseg, pease, pv, pvv, pslice, xv, xvv, bTransform, oTransform, rnProp, rnMatrix, mountRn
...
{ type: 'Svg', staticProps: { viewBox: '0 0 1080 1080', width: '100%', height: '100%', preserveAspectRatio: 'xMidYMid meet' }, children: [
  ...
  { type: 'G', staticProps: { clipPath: 'url(#vp0)' }, children: [
    ...
    { type: 'G', slot: 2, staticProps: { transform: [.4, 0, 0, .4, 492.16, 842.45] }, children: [
