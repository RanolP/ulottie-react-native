...
// runtime symbols: fmt, r, dec, H_FR, H_IP, H_OP, H_EASINGS, H_TIMELINES, H_GATES, H_PROGRAM, H_REMAPS, INV, P10, put, open, lerpPath, T_PATH, T_EXPR, F_EASE, F_HOLD, pseg, pease, pvp, mkPath, pdPair, pdSep, pathD, hasTrim, bShape, oShape, skSet, skMatrix, skNums, skGeom, skPaints, skGrad, skOwn, skFxPaint, mountRn, skPrepare, skGradRec, skDraw, skFx, skShape, skGeomDraw, mountSkia
...
{ k: 0, c: [
  { k: 0, clip: { r: [0, 0, 500, 500] }, c: [
    { k: 0, m: [1, 0, 150, 0, 1, 150, 0, 0, 1], c: [
      { k: 0, mask: { luma: 1, c: [
        { k: 2, h: 500, w: 500, x: 0, y: 0, paint: { f: '#ffffff' } },
        { k: 1, s: 7, d: 'M100,50C72.386,50,50,72.386,50,100C50,127.614,72.386,150,100,150C127.614,150,150,127.614,150,100C150,72.386,127.614,50,100,50Z', paint: { f: '#000' } }
      ] }, c: [
        { k: 2, h: 200, w: 200, x: 0, y: 0, paint: { f: '#ea0c11' } }
      ] }
    ] }
  ] }
] };
...
export const init = (Sk) => { 'worklet'; return mountSkia(D, P0, A0, 8, null, Sk, dl); };
